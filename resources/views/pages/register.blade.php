    ...
    <div class="col-12 border mt-5">
        ...
        <form action="{{ route('registerpage') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="mobilenumber" id="mobilenumber" placeholder="Enter Mobile Number" class="form-control" value="{{ old('mobilenumber') }}">
                <span class="text-danger">@error('mobilenumber'){{ $message }} @enderror</span>
            </div>
            <div class="form-group">
                <label for="password">Password</label>
                <input type="password" name="password" id="password" placeholder="Enter Password" class="form-control" value="{{ old('password') }}">
